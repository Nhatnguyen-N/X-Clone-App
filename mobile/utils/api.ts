...
const API_BASE_URL = process.env.EXPO_PUBLIC_API_URL || "https://x-clone-app-livid.vercel.app/api";
// const API_BASE_URL = "http://192.168.1.7:5001/api";


// this is basically create an authenticated api, pass the token into our headers
